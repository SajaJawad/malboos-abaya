      ...
      <div className="max-w-4xl w-full bg-white rounded-[4px] border border-[#E8DDD0] overflow-hidden shadow-sm grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative min-h-[300px] md:min-h-full hidden md:block bg-[#E8DDD0]/40">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#151311]/60 via-transparent to-transparent flex flex-col justify-end p-8 text-[#F7F2EA]">
            ...
            <p className="text-xl font-light mt-1">أهلاً بك مجدداً في عالم الفخامة</p>
          </div>
        </div>
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center space-y-6">
          <div className="text-center md:text-right">
            <Logo size="sm" />
            <h1 className="text-2xl font-normal text-[#151311] mt-4">تسجيل الدخول</h1>
            <p className="text-xs text-[#7B746E] mt-1">أدخلي بياناتك لمتابعة التسوق وإدارة طلباتك</p>
          </div>
          ...
          <form className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                <label className="text-xs font-semibold text-[#151311]">كلمة المرور</label>
                <Link href="/forgot-password" className="text-[11px] text-[#C4A36B] hover:underline">
                  نسيت كلمة المرور؟
                </Link>
              </div>
              <input
          ...
          <div className="text-center pt-4 border-t border-[#E8DDD0] text-xs text-[#7B746E]">
            ليس لديك حساب بعد؟{' '}
            <Link href="/register" className="text-[#151311] font-bold hover:text-[#C4A36B]">
              أنشئي حساباً جديداً
            </Link>
          </div>
        </div>
